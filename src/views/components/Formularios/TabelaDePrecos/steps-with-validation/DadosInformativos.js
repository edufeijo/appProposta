...
const DadosInformativos = ({ userData, empresa, proposta, setProposta, versaoDaProposta, setVersaoDaProposta, tabelaDeItens, setTabelaDeItens, template, operacao, stepper, type }) => {
  return (
    <Fragment>
      <LinhaALinha 
        userData={userData} 
